...
import { RemoveNodeRequest, RemoveNodeResponse } from "../types/services/RemoveNode";
import { AddNodeRequest, AddNodeResponse } from "../types/services/AddNode";
import { GenerateSubtreeRequest, GenerateSubtreeResponse } from "../types/services/GenerateSubtree";
...
export class MultipleSelection extends Component<MultipleSelectionProps, MultipleSelectionState> {
    buildNodeMessage(): any {
        throw new Error("Method not implemented.");
    }
    generate_subtree_service: ROSLIB.Service<GenerateSubtreeRequest, GenerateSubtreeResponse>;
    ...
    unwire_data_service: ROSLIB.Service<WireNodeDataRequest, WireNodeDataResponse>;
    ...
    componentDidUpdate(prevProps: MultipleSelectionProps, prevState: MultipleSelectionState) {
    ...
    render() {
        ...
        return (
            <div className="d-flex flex-column">
                ...
                <div className="d-flex flex-column">
                    <h5>Filename <i title="Filename/Path of the subtree TODO" className="fas fa-question-circle"></i></h5>
                    <input className="form-control-lg mb-2"
                        type="text"
                        value={this.state.filename}
                        onChange={this.setFilename}
                        disabled={true} />
                    <h5>Package <i title="The ROS package in which the newly created subtree will be saved in" className="fas fa-question-circle"></i></h5>
                    <input className="form-control-lg mb-2"
                        type="text"
