...
export class NodeListItem extends Component<NodeListItemProps, NodeListItemState> {
    ...
    renderTags(tags: string[]) {
        ...
        var bubbles = tags.map(data => {
            return (
                <span className="border rounded p-2 m-1 tag">{data}</span>
            );
        });
            ...
            <div className={border}
                ...
                <div className="d-flex justify-content-between">
                    <div className="d-flex minw0">
                        ...
                        <i title={getShortDoc(this.props.node.doc)} className="fas fa-question-circle pl-2 pr-2"></i>
                    </div>
                    <div className="d-flex minw0">
                        <i onClick={this.toggleCollapsed.bind(this)} className={collapsible_icon}></i>
                    </div>
                </div>
