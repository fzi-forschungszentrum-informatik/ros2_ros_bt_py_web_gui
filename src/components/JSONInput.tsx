...
export class JSONInput extends Component<JSONInputProps, JSONInputState> {
    ...
    getJSONfromPyObject(pyobject: Object, field_names: string[]): { json: Object, counter: number } {
        var json = {};
        var counter = 0;
    ...
    handleChange = () => {
        try {
            ...
            if (this.props.output == "pickled") {
                var reconstructed = this.getPyObjectFromJSON(JSON.parse(this.state.pyobjectstring!), json);
