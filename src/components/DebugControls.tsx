...
import { SetExecutionModeRequest, SetExecutionModeResponse } from "../types/services/SetExecutionMode";
...
export class DebugControls extends Component<DebugControlsProps, DebugControlsState> {
