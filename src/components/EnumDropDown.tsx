...
export class EnumDropDown extends Component<EnumDropDownProps, EnumDropDownState> {
    ...
    componentDidUpdate(prevProps: EnumDropDownProps, prevState: EnumDropDownState) {
