...
import { ServicesForTypeRequest, ServicesForTypeResponse } from "../types/services/ServicesForType";
...
export class NamespaceSelect extends Component<NamespaceSelectProps, NamespaceSelectState> {
    servicesForTypeClient?: ROSLIB.Service<ServicesForTypeRequest, ServicesForTypeResponse>;
