...
interface SaveFileBrowserState {
...
export class SaveFileBrowser extends Component<
  SaveFileBrowserProps,
...
> {
  ...
  constructor(props: SaveFileBrowserProps) {
    super(props);
