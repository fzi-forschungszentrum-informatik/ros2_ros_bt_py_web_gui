...
export class TickControls extends Component<TickControlsProps, TickControlsState> {
    tick_service?: ROSLIB.Service<ControlTreeExecutionRequest, ControlTreeExecutionResponse>;
