...
import { createVNode, h, ref, type Ref, type VNodeRef } from 'vue';
...
<template>
    ...
    <div>
        ...
        <button @click="() => openFileDialog()" class="btn btn-primary ms-1" title="Upload">
            <font-awesome-icon icon="fa-solid fa-file-upload" aria-hidden="true" class="show-button-icon" />
            <span class="ms-1 hide-button-text">Upload</span>
        </button>
    </div>
    <button @click="() => saveTree()" class="btn btn-primary m-1" title="Download">
        <font-awesome-icon icon="fa-solid fa-file-download" aria-hidden="true" class="show-button-icon" />
