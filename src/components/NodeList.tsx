...
export class NodeList extends Component<NodeListProps, NodeListState> {
    ...
    render() {
        var byName = function (a: DocumentedNode, b: DocumentedNode) {
        ...
        var moduleThenName = function (a: DocumentedNode, b: DocumentedNode) {
        ...
        var items: JSX.Element[] | null = nodes
            .sort(moduleThenName)
            .map((node) => {
            ...
            <div className="available-nodes m-1">
                <div className="vertical_list">
                    <div className="border rounded mb-2">
                        <div onClick={this.toggleNodeListCollapsed.bind(this)} className="text-center cursor-pointer font-weight-bold m-2">Node List <i className={node_list_collapsible_icon}></i></div>
                        {items}
                    </div>
                </div>
            </div>
