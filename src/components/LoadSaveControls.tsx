...
import { ControlTreeExecutionRequest, ControlTreeExecutionResponse, TreeExecutionCommands } from "../types/services/ControlTreeExecution";
...
import { ClearTreeRequest, ClearTreeResponse } from "../types/services/ClearTree";
...
export class LoadSaveControls extends Component<LoadSaveControlsProps> {
    ...
    control_tree_execution_service?: ROSLIB.Service<ControlTreeExecutionRequest, ControlTreeExecutionResponse>;
    ...
    handleFileRead(event: ProgressEvent<FileReader>) {
        ...
        try {
            ...
            var file_text: string = this.fileReader.result as string
            msgs = jsyaml.loadAll(file_text) as TreeMsg[];
            var msg: TreeMsg | null = null;
