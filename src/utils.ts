...
export let python_builtin_types = [
  'int',
  'float',
  'long',
  'str',
...
export function getDefaultValue(typeName: string, options: NodeData[] | null = null): { type: string, value: any } {
  if (typeName === 'type') {
    return {
      type: 'type',
      value: 'int'
...
export function selectIOGripper(vertex_selection, data) {
